...
pub mod greeter_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn healthz(
            &mut self,
            request: impl tonic::IntoRequest<super::HealthzReq>,
        ) -> std::result::Result<tonic::Response<super::HealthzReply>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/Hello.Greeter/Healthz");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("Hello.Greeter", "Healthz"));
...
pub mod greeter_server {
    ...
    pub trait Greeter: std::marker::Send + std::marker::Sync + 'static {
        async fn healthz(
            &self,
            request: tonic::Request<super::HealthzReq>,
        ) -> std::result::Result<tonic::Response<super::HealthzReply>, tonic::Status>;
        async fn say_hello(
            &self,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/Hello.Greeter/Healthz" => {
                    #[allow(non_camel_case_types)]
                    struct HealthzSvc<T: Greeter>(pub Arc<T>);
                    impl<T: Greeter> tonic::server::UnaryService<super::HealthzReq> for HealthzSvc<T> {
                        type Response = super::HealthzReply;
                        ...
                        fn call(
                            ...
                            let fut = async move { <T as Greeter>::healthz(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                ...
                "/Hello.Greeter/SayHello" => {
                    ...
                    impl<T: Greeter> tonic::server::UnaryService<super::HelloReq> for SayHelloSvc<T> {
